...
|---|---|---|---|---|---|---|
| 02 | _ceiling | 13-band | 0.985 ± 0.002 | 0.984 ± 0.002 | — | full-supervision ceiling used as the dashed line in the NB04 headline figure |
...
| 02 | arm2_resnet18_randomstem | 13-band | 0.982 ± 0.000 | 0.982 ± 0.000 | 11.21M | ablation, 1 seed — pretrained stem discarded |
| 02 | arm2_resnet18_rgb | RGB only | 0.979 ± 0.000 | 0.978 ± 0.000 | 11.18M | ablation, 1 seed — the fair comparison for CLIP |
